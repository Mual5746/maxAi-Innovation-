...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    if (data.success) {
      setResult("Medelandet skickades");
      event.target.reset();
    } else {
      ...
      <div className='contact' >
        ...
        <div className="contact-col">
            <form action="" onSubmit={onSubmit}>
                <label htmlFor="">Dit namn</label>
                <input type="text" name='name' placeholder='Skriv dit namn' required />
                <label htmlFor="">Dit nummer</label>
                <input type="tel" name='phone' placeholder='Skriv dit nummer' required />
                <label htmlFor="">Dit medelande</label>
                <textarea name="message"  rows="6" placeholder='Skriv ditt medelande...' required></textarea>
